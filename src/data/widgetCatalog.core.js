...
export const CORE_CONTENT_CATEGORIES = [
    // ── 1. DATA I/O ─────────────────────────────────────────────────────────
    {
        id: 'data_io',
        accent: '#00f5ff',
    ...
    // ── FFT AND STATISTICS CONTENT ─────────────────────────────────────────────
    {
        id: 'frequency_statistics_content',
        accent: '#3b82f6',
        status: 'available',
        en: { name: 'FFT and statistics content', blurb: '' },
        tr: { name: 'FFT ve istatistik içeriği', blurb: '' },
        widgets: [
            {
                id: 'fft_spectrum',
...
// This module is a bilingual content reservoir. The public, application-aligned
// topology is assembled in widgetCatalog.js.
export default CORE_CONTENT_CATEGORIES
